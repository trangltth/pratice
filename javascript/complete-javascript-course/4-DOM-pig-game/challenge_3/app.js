...
document.querySelector('.btn-roll').addEventListener('click', function () {
  ...
  document.querySelector('#dice-0').src = "/4-DOM-pig-game/challenges_1/images/dice-" + dice_1 + ".png";
  document.querySelector('#dice-1').src = "/4-DOM-pig-game/challenges_1/images/dice-" + dice_2 + ".png";
